    ...
    render(): JSX.Element {
        ...
        return (
            <div className='mt-10 text-center p-7'>
                <h1 className='text-[20px] font-bold' data-aos='zoom-out-right' data-aos-anchor='#footer-animation'>Szymon.ml</h1>
                <p className='text-[15px]' data-aos='zoom-out-right' data-aos-anchor='#footer-animation'>
