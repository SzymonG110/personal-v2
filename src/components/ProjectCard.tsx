...
export default class ProjectCard extends Component<Props, Readonly<{}>> {

    lock(): JSX.Element {

        if (this.props.public)
            return (
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 absolute top-2 right-2" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div>
                    <h4 className='flex items-center text-xs'>
                        <div className='bg-[#ffffff] h-3 w-3 rounded-full flex justify-center items-center mr-1'>
                            <div className={`bg-[${this.props.language.color}] h-2 w-2 rounded-full`} style={{ background: this.props.language.color }} />
                        </div>
